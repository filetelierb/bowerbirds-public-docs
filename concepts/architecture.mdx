...
The macOS and iOS apps are the main surfaces for capture, review, annotation, and organization. The macOS CLI lets scripts work with filed local Buckets and, signed in, with the cloud.
