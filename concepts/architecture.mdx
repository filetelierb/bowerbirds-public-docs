...
Cloud features are optional and operate on the Buckets you choose to sync or share. They enable collaboration, cross-device access, Web Capture, routers that dispatch what lands in the Buckets they supervise, and approved remote integrations.
...
| Dispatch what lands in one or more Buckets | A [router](/cloud/routers): an ordered list of routes, Bowerbirds AI, or [your own agent](/cloud/external-routers) |
