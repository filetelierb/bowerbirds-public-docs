...
Bundled templates are **Transcript**, **Meeting notes**, **1:1**, **Stand-up**, **Walkthrough guide**, and **Bug report**. Organization templates can be edited, removed, restored, or created to combine outputs differently.
